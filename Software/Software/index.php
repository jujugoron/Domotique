    ...
    <div class="row">
        ...
        <div class="col-xs-10 col-lg-5">
          ...
          <div>
            ...
            <p class="para">interieur: <span id="Temperature"></span> °C</p> <p class="para">exterieur: <?php echo(5); ?> °C</p> <br>
            ...
            <p class="para">humidité: <span id="Humidity"></span>%</p> 
            ...
            <p class="para">batterie: <span id="Batterie"></span>%</p>
        ...
        <div class="col-md-offset-2 col-md-10 col-lg-offset-0 col-lg-4">
          ...
          <div>          
            ...
            <p class="para">chauffe: <span id="Prise"></span></p>

            <p class="para">consigne: <?php echo( $Temperature); ?> °C</p>
